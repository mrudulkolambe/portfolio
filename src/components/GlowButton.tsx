...
const GlowButton = ({ child }: { child: React.ReactNode }) => {
	return (
		<button className="group w-full relative inline-flex h-12 overflow-hidden rounded-xl p-[1px] focus:outline-none">
			<span className="opacity-0 group-hover:opacity-100 duration-200 absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#191919_0%,#191919_50%,#787878_100%)]" />
